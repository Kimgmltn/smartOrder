...
class ItemServiceTest {
    ...
    void test() {
        ...
        SaveCategoryResponse categories = categoryService.saveCategories(new SaveCategoryRequest(company.getCompanyId(), List.of("갈비", "식사", "음료")));
        ...
        SaveItemRequest request = new SaveItemRequest(categoryId, List.of(item1, item2));
